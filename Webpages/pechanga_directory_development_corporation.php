<html>
    <head>
        <title>Pechanga - Development Corporation Department</title>
    ...
    <body>
        <div class="fade-in-image">
            <div class="banner">
                ...
                <div class="content">
                    <h1>PECHANGA DEVELOPMENT CORPORATION</h1>
                    <p>List of employees in deparment.</p>
                    <?php
                        $division = "Pechanga Development Corporation";
                        include '../Supplementary Files/search.php';
                    ?>
            </div> 
            <div class="footer">
